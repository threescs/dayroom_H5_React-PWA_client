        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                if (!platform) {
                    ...
                    console.log("Currently Danger JS only supports GitHub and BitBucket Server, if you want other platforms, consider the Ruby version or help add support.");
                    process.exitCode = 1;
                }
            ...
            case 3:
                ...
                processName = (app.process && app.process.split(" ")) || undefined;
